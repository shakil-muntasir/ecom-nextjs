    ...
    <main className='flex'>
      <aside className='w-2/12 bg-white h-screen'>
        ...
        <nav className='mt-14 flex flex-col gap-y-6'>
          ...
          <Link href='/orders' className={`flex items-center mx-6 hover:bg-slate-100 px-7 py-1 rounded-md ${isActive('/orders') ? 'bg-slate-100' : ''}`}>
            <svg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 24 24' strokeWidth={1.5} stroke='currentColor' className='w-6 h-6'>
              <path
                strokeLinecap='round'
                strokeLinejoin='round'
      ...
      <main className='bg-gray-50 flex-1 p-3'>
        <header className='ml-12 flex justify-between items-center'>
          <h1 className='font-semibold text-3xl tracking-wide uppercase text-[#F47458]'>Sunnah Station</h1>
